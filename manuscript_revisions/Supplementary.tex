...
Correspondence concerning this article should be addressed to Cillian McHugh, Limerick, V94 T9PX. E-mail: \href{mailto:cillian.mchugh@ul.ie}{\nolinkurl{cillian.mchugh@ul.ie}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{../resources/images/mps4.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{../resources/images/mm1.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta1.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta1bad.png}}
\caption{Forest plot showing effects for bad characters for Studies 1 and 3 and pooled effect.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta1good.png}}
\caption{Forest plot showing effects for good characters Studies 2 and 3 and pooled effect.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta2.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta2bad.png}}
\caption{Forest plot showing effects for bad characters for all studies and pooled effect.}
\end{figure}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{meta2good.png}}
\caption{Forest plot showing effects for good characters for all studies and pooled effect.}
\end{figure}
