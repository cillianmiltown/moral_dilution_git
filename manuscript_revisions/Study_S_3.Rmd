...
supp_s3bad_rtot_stats <- s_pooled_fun()
d <- supp_s3bad_rtot_stats$d
...
supp_s3bad_M1_stats <- s_pooled_fun()
d <- supp_s3bad_M1_stats$d
d
...
supp_s3good_rtot_stats <- s_pooled_fun()
d <- supp_s3good_rtot_stats$d
...
supp_s3good_M1_stats <- s_pooled_fun()
d <- supp_s3good_M1_stats$d
d

save(supp_s3good_rtot_stats
     , supp_s3good_M1_stats
     , supp_s3bad_rtot_stats
     , supp_s3bad_M1_stats, file = "supp_S3_effect_stats.RData")
