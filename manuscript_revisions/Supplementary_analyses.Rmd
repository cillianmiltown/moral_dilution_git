...
```{r pilot1cobminedconditionplotVIOLIN, fig.cap="Pilot Study 1: Differences in combined measure depending on condition", include=FALSE, out.width = "\\textwidth", fig.pos = "!h"}
