...
model0 <- lmerTest::lmer(R_tot_extremity ~ 1
                #   condition
                 + (1|ResponseId)
...
summary(model0)
model1 <- lmerTest::lmer(R_tot_extremity ~
                  condition*scenario
                + (1|ResponseId)
                + (1|ResponseId:condition)
                , data = x
